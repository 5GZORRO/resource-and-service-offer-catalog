...
import it.nextworks.tmf_offering_catalog.interfaces.ResourceSpecificationInterface;
import it.nextworks.tmf_offering_catalog.services.ResourceSpecificationService;
...
public class ResourceSpecificationController implements ResourceSpecificationInterface {
    ...
    createResourceSpecification(@ApiParam(value = "The ResourceSpecification to be created" ,required=true )
        ...
        try {
            rs = resourceSpecificationService.create(serviceSpecification);
